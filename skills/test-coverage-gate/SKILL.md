...
description: "Godmode Skill: Forces the AI agent to write or update test files whenever it modifies application logic. Run 'driftlock guard --tests' before committing to enforce this rule."
---

## Overview

This skill teaches the agent how to navigate the `driftlock` Test Coverage Gate. 
...
4. **Validation**: Run `driftlock guard --tests` to mathematically verify your diff will pass the coverage gate.

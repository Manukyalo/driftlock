...
async function runTests() {
  ...
  let access = await gateway.checkAccess('guard');
  assert(access.licensed === true, 'checkAccess returns licensed for pro command (guard)');
  ...
  access = await gateway.checkAccess('guard');
